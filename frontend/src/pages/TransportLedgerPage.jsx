...
export default function TransportLedgerPage() {
  ...
  const pager = useCompactList(rows, row => [row.date, row.plate_no, row.category, row.material, row.quantity, row.note]);
